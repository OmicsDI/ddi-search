//package uk.ac.ebi.ddi.maven.ddisearchboot.repo.mongo.Impl;
//
//import uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.*;
//import uk.ac.ebi.ddi.maven.ddisearchboot.repo.mongo.IMongoDataRepo;
//import uk.ac.ebi.ddi.maven.ddisearchboot.repo.mongo.mongoModel.DatabaseDetail;
//import uk.ac.ebi.ddi.maven.ddisearchboot.repo.mongo.mongoModel.Dataset;
...
//        List<Entry> entryList = list.stream().map(x -> {
...
//            if(dateMaps != null) {
//                List<uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.Date> dateList = new ArrayList<>();
//                for (String key : dateMaps.keySet()) {
//                    for (String value : dateMaps.get(key)) {
//                        uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.Date date = new uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.Date();
//                        date.setType(key);
//                        date.setValue(value);
//                        dateList.add(date);
//                    }
