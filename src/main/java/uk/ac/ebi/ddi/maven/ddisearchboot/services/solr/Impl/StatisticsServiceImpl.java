...
import uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.Domain;
import uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.DomainList;
import uk.ac.ebi.ddi.maven.ddisearchboot.model.mongo.IndexInfo;
import uk.ac.ebi.ddi.maven.ddisearchboot.repo.solr.SolrEntryRepo;
import uk.ac.ebi.ddi.maven.ddisearchboot.services.solr.IStatisticsService;
...
public class StatisticsServiceImpl implements IStatisticsService {
    ...
    public DomainList getQueryResult() {
        ...
        for (Map.Entry<String, NamedList<Object>> status : coreStatus) {
            ...
            subDomain.setId(domain.getId());
            subDomain.setName(domain.getId());
            subDomain.setDescription(domain.getId());


            domain.setSubdomains(new Domain[]{subDomain});
            domains.add(domain);
        }
